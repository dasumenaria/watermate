<div class="portlet box blue">
	...
	<?php pr($record); foreach ($record as $records):
	
	$cum=$records->village->commissioning;
	endforeach; ?>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					  <?=$this->Form->control('commissioning',['class'=>'form-control','value'=>$cum ])?>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					  <?=$this->Form->control('atmcard_issues',['class'=>'form-control'])?>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-4">
				<div class="form-group">
				<?=$this->Form->control('village_name', ['options' => $villages,'class'=>'select2me form-control'])?>
				</div>
			</div>
			<div class="col-md-4">
				<div class=" ">
